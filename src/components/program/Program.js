                ...
                <Grid item xs={12} md={12}>
                    <Grid container align="center">
                        <Grid item xs={12} md={4} className="articalCardGrid">
                            <Link to="/corporatePrograms" style={{textDecoration:"none"}}>
...
{/* ----------------------------card-2----------------------------------- */}
                        ...
                        <Grid item xs={12} md={4} className="articalCardGrid">
                            <Link to="/individualPrograms" style={{textDecoration:"none"}}>
                                <Card className="articalCard" style={{width:"90%",height:"80%"}}
                                    onClick={()=>
                                        setOpen(true)}
                                >
...
{/* ----------------------------card-3----------------------------------- */}
                        ...
                        <Grid item xs={12} md={4} className="articalCardGrid">
                            <Link to="/GroupPrograms" style={{textDecoration:"none"}}>
                                <Card className="articalCard" style={{width:"90%",height:"80%"}} 
                                    onClick={()=>
                                        setOpen(true)}
                                >
